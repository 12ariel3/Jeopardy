...
const jeopardyCategories = [
    ...
    },
    {
        ...
        questions: [
            {
                question: 'How many players in a footbal team?',
                answers: ['15', '11'],
                correct: '11',
                level: 'easy'
            },
...
function getResult(){
    ...
    const cardOfButton = parentOfButton.parentElement
    ...
    if(cardOfButton.getAttribute('data-correct') == this.innerHTML){
        ...
        setTimeout(()=>{
            ...
            cardOfButton.innerHTML = "DONE!"
            cardOfButton.style.fontSize = '36px'
            cardOfButton.style.display = 'grid'
            cardOfButton.style.justifyItems = 'center'
            cardOfButton.style.alignItems = 'center'
        },100)
    }else{
        ...
        setTimeout(()=>{
            ...
            cardOfButton.innerHTML = 'WRONG :c'
            cardOfButton.style.fontSize = '36px'
            cardOfButton.style.display = 'grid'
            cardOfButton.style.justifyItems = 'center'
            cardOfButton.style.alignItems = 'center'
